...
interface PenjualanPageEnhancedProps {
  selectedDivision: string;
}

const PenjualanPageEnhanced = ({ selectedDivision }: PenjualanPageEnhancedProps) => {
  ...
  const calculateTotals = () => {
    ...
    return { totalPenjualan, totalUnit };
  };

  const { totalPenjualan, totalUnit } = calculateTotals();
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-muted-foreground">
                  Total Penjualan {dateFilter !== "all" ? `(${dateFilter.replace('_', ' ')})` : ''}
                </p>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-muted-foreground">
                  Total Unit {dateFilter !== "all" ? `(${dateFilter.replace('_', ' ')})` : ''}
                </p>
...
export default PenjualanPageEnhanced;