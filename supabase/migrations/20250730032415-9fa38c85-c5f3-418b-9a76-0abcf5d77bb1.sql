...
DROP VIEW IF EXISTS public.assets_combined;
DROP VIEW IF EXISTS public.pembelian_combined;
DROP VIEW IF EXISTS public.pembukuan_combined; 
DROP VIEW IF EXISTS public.penjualans_combined;

-- Recreate assets_combined view without SECURITY DEFINER
...
-- Recreate pembelian_combined view without SECURITY DEFINER
...
-- Recreate pembukuan_combined view without SECURITY DEFINER  
...
-- Recreate penjualans_combined view without SECURITY DEFINER
