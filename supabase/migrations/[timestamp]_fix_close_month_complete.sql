...
BEGIN
    ...
    -- Fix column mapping for cicilan_history
    INSERT INTO cicilan_history (
        id, penjualan_id, cicilan_ke, nominal_dana_1, nominal_dana_2, 
        sumber_dana_1_id, sumber_dana_2_id, tanggal_bayar, keterangan, 
        created_at, updated_at, closed_month, closed_year, closed_at
    )
    SELECT 
        id, penjualan_id, cicilan_ke, jumlah_bayar, 0,
        tujuan_pembayaran_id, NULL, tanggal_bayar, keterangan,
