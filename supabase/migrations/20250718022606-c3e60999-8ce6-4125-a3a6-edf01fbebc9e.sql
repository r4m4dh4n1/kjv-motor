...
CREATE TABLE public.biro_jasa_cicilan (
  id integer NOT NULL DEFAULT nextval('biro_jasa_cicilan_id_seq'::regclass) PRIMARY KEY,
...
-- Create sequence for biro_jasa_cicilan
CREATE SEQUENCE IF NOT EXISTS biro_jasa_cicilan_id_seq;
