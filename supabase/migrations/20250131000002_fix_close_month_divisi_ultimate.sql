-- ULTIMATE FIX: Fix close_month function to properly handle divisi column for cicilan_history
-- This migration fixes the "column divisi does not exist" error by updating the latest close_month function
-- to include divisi column in cicilan_history INSERT statement
