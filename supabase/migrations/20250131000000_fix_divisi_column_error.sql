-- Fix divisi column error in close_month function
-- This migration addresses the "column divisi does not exist" error

-- Add divisi column to history tables if they don't exist
