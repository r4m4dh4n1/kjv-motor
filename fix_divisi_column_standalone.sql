-- STANDALONE FIX: Fix close_month function to properly handle divisi column for cicilan_history
-- This script can be run directly in your Supabase SQL Editor or any PostgreSQL client
-- It fixes the "column divisi does not exist" error by updating the close_month function
